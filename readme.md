# Система контроля версий и удаленными репозиториями
...
для слияния веток используется команда git merge.  Применяется следуюющим образом git merge "название ветки"